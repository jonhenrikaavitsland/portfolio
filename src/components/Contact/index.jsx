  ...
  return (
    <div className='border-b border-black/20'>
      <div className='lg:container flex flex-col md:flex-row gap-10 md:gap-0 mx-auto px-5 py-15 '>
        ...
        <div className='flex-1 flex flex-col gap-5 mx-auto md:mx-0'>
          <div>
            <button className='p-3 rounded-lg capitalize w-40 bg-black hover:bg-black/60 text-white font-semibold cursor-pointer'>linkedIn</button>
          </div>
          <div>
            <button className='p-2.75 rounded-lg capitalize w-40 bg-white hover:bg-black/20 border border-black font-semibold cursor-pointer'>github</button>
          </div>
        </div>
      </div>
    </div>
